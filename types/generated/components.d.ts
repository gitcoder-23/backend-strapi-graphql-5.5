...
export interface SharedNewSiteSeo extends Struct.ComponentSchema {
  collectionName: 'components_shared_new_site_seos';
  info: {
    displayName: 'SiteSeo';
  };
  attributes: {
...
export interface LayoutHeroBanner extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    downloadLink: Schema.Attribute.Component<'components.link', false>;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      'shared-new.site-seo': SharedNewSiteSeo;
